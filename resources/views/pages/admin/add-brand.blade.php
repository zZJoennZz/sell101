                    ...
                    <div class="card-content" style="padding-bottom:0;">
                        <div class="row valign-wrapper" style="margin-bottom: 24px;">
                            ...
                            <div class="col s9 m10" style="padding-left:0;">
                                <span class="card-title" style="margin-bottom:0; font-size:1.5rem;">Add Brand</span>
                                <p class="grey-text" style="font-size:1rem;">Create a new brand for your products.</p>
                            </div>
                        </div>
                        @if(session('success'))
                        ...
                        @endif
                        <form id="add-brand-form" method="POST" action="{{ route('admin.storebrand') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row" style="margin-bottom:0;">
                                <div class="input-field col s12" style="margin-bottom:8px;">
                                    ...
                                    <span class="helper-text" data-error="Required" data-success="">Brand name (e.g. X, Y, Z)</span>
                                </div>
                                <div class="input-field col s12" style="margin-bottom:8px;">
                                    ...
                                    <span class="helper-text" data-error="Required" data-success="">URL-friendly identifier (e.g. x-y-z)</span>
                                </div>
                                <div class="input-field col s12" style="margin-bottom:8px;">
                                ...
                                <div class="file-field input-field col s12" style="margin-bottom:8px;">
                                    ...
                                    <div class="file-path-wrapper">
                                        <input class="file-path validate @error('image') invalid @enderror" type="text" placeholder="Upload logo">
                                    </div>
                                ...
                                <div class="col s12 right-align" style="margin-top:16px; margin-bottom:16px;">
                                    <button class="btn waves-effect waves-light" type="submit" style="width:100%;max-width:220px;">Add Brand
